...
class StarryGalaxy:
  ...
  def _create_star(self, x_position, y_position):
    ...
    # print(f"Star added at ({x_position}, {y_position}), total: {len(self.stars)}")
      
  def _create_stars(self):
    """Create a galaxy of stars."""
    # Create a star and keep adding stars until there is no more space in the row.
    star = Star(self)
  ...
  def _update_screen(self):
    ...
    # print(f"Drawing {len(self.stars)} stars")
